    ...
    <div className={styles.container}>
      <div className={styles.columns}>
        ...
        <div className={styles.column}>
          ...
          <p><strong>Select from the Largest Online Marketplace in Pakistan</strong><br />
          ...
          <h4>What Makes Us Different from Other Online Shopping Platforms?</h4>
          <p><b>Select from the Largest Online Marketplace in Pakistan</b><br />
...
<br /><br /><b>Hassle Free Delivery
</b><br />Online shopping is only as good as its execution and Daraz promises hassle free delivery right from the moment you order to when your package is dropped at your door. We cater to both major and smaller cities alike, and give you the choice to track your package as it makes its way to you so you always know your order status. If you are unsatisfied with any aspect of your order, we have a simple 7-day return or exchange policy.

<br /><br /><b>Payment Options to Suit Every Style
</b><br />You can choose to pay through a credit/debit card, opt for cash on delivery or even go for EMI (easy monthly instalments). You can also</p>
        </div>

        {/* Column 2: Categories */}
            <div className={styles.column}>
          <p>avail exclusive offers by downloading Daraz Wallet – a closed loop digital wallet that offers you a secure, easy way to make payments. We also have easypaisa & jazzcash payment method for our customers' ease
<br />
<br />
...
<br /><br /><b>Avail Exclusive Discounts, Offers, and Promotions
</b><br />Online shopping with Daraz means you get the chance to avail exclusive online-only promotional packages as well as discount vouchers from our vendors when you shop from their pages. Our flash sales give you customized product offers all curated with the help of our advanced AI technology so you always have deals you’ll actually be interested in!

<br /><br /><b>Buy Value, not Just Goods with Daraz Care
</b><br />Daraz does not just cater online shopping in Pakistan but also aims to simplify the way you give back to society. With charities spanning across sectors of education, health care, environmental preservation, and shelters, you can choose to make a big difference with a few, simple clicks.

<br /><br /><b>Simplify Corporate Purchases
</b><br />Who says corporate purchases need to be a complicated affair? When you opt for Daraz Corporate, you get an efficient and transparent solution for your business’ bulk purchasing needs. We’re proud to be working with some of the most prestigious organizations in Pakistan across a number of different industries.
          </p>
        </div>

        {/* Column 3: Fashion + Grocery */}
          <div className={styles.column}>
          <h4>Top Categories & Brands</h4>
          <p><b>MOBILE PHONES IN PAKISTAN</b>
          <br />
...
<br /><br />
<b>DSLR CAMERAS
</b><br />Camera Tripods , Drones , IP & CCTV Cameras , Nikon D7000 , Nikon D5600 , Canon 200D , Canon 1200D , Fujifilm Instax Mini 11 , Canon M50

<br /><br /><b>HEALTH & BEAUTY
</b><br />sunisa foundation , Biofad , janssen facial kit , Glutathione Injection , Glutathione Cream , Sauvage , Glutathione Tablets , Glutathione Soap , Infrared Thermometers , N95 Mask
<br /><br /><b>TRENDING
</b><br />Online Bills , Core I5 Laptop , Gtx 1060 , Samsung A32 , Samsung A51 , Samsung A52 , Samsung A71 , Samsung A72 , Samsung M31 , Samsung S20 , Samsung S20 Ultra 5G , Samsung S21 , Samsung S21 Ultra , Samsung Z Flip , Tecno Camon 17 , Tecno Spark 6 , Vivo V20 , Poco X3 Pro , Vivo V21 , Vivo V21E , Vivo X70 Pro , Vivo Y12 , Vivo Y12S , Vivo Y1S , Vivo Y20 , Vivo Y51 , Vivo Y51S , Oppo F19 Pro , Oppo Reno 6 , Xiaomi Poco F3 , Xiaomi Poco M3 , Xiaomi Poco X3 , Xiaomi Poco X3 Gt , Xiaomi Redmi 9C , Xiaomi Redmi Note 10 Pro , Sharp Aquos R2
          </p>
        </div>

        {/* Column 4: Global Shopping */}
         <div className={styles.column}>
          <p>WOMEN'S FASHION
...
<br /><br /><b>SHOP WORLDWIDE WITH LAZADA
</b><br />
